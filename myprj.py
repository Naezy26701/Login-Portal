...
db = mysql.connector.connect(host="localhost",user="root",passwd="root",database="miniproject")
mycur = db.cursor()
...
def error():
    ...
    Label(err,text="All fields are required..",fg="#0089ff",font="bold").pack()
    Label(err,text="").pack()
    Button(err,text="Ok",bg="#0089ff",width=8,height=1,command=error_destroy).pack()
...
def success():
    ...
    Button(succ, text="Ok", bg="#0089ff", width=8, height=1, command=succ_destroy).pack()
...
def registration():
    ...
    Label(root1, text="").pack()
    Button(root1,text="Register",bg="#0089ff",command=register_user).pack()
...
def login():
    ...
    Label(root2, text="").pack()
    Button(root2, text="Log-In", bg="#0089ff",command=login_varify).pack()
    Label(root2, text="")
...
def logged():
    ...
    Label(logg, text="Welcome {} ".format(username_varify.get()), fg="#080806", font="bold").pack()
...
def failed():
    ...
    Label(fail, text="Invalid credentials...", fg="#0089ff", font="bold").pack()
    Label(fail, text="").pack()
    Button(fail, text="Ok", bg="0089ff", width=8, height=1, command=fail_destroy).pack()
...
def main_screen():
    ...
    Button(root,text="Log-IN",width="8",height="1",bg="#0089ff",font="bold",command=login).pack()
    Label(root,text="").pack()
    Button(root, text="Registration",height="1",width="15",bg="#0089ff",font="bold",command=registration).pack()
    Label(root,text="").pack()
    Label(root,text="").pack()
    Label(root,text="Developed By Mohd.Naved").pack()
